...
--- | --- | --- | ---
[account_move_export](account_move_export/) | 16.0.1.0.0 (unported) | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Export journal entries to specific formats
[account_move_export_quadra](account_move_export_quadra/) | 16.0.1.0.0 (unported) | [![hparfr](https://github.com/hparfr.png?size=30px)](https://github.com/hparfr) | Export journal entries to Quadratus Compta
