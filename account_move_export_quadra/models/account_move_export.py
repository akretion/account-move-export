...
class AccountMoveExport(models.Model):
    ...
    def _prepare_columns(self):
        ...
        cols["Numéro de pièce jusqu'à 8 caractères"] = {"width": 8}
        ...
        cols["Code TVA 2"] = {"width": 2}
        cols["N° de pièce alphanumérique sur 10 caract."] = {"width": 10}
        cols["Reservé"] = {"width": 10}  # osef
        cols["Signe dans la devise"] = {"width": 1}  # osef
        cols["Montant dans la devise non signé"] = {"width": 12}  # osef
